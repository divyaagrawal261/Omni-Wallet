...
function AddIncome()
{
    return(
        ...
        <div className="w-full md:w-1/2 lg:w-1/2 text-3xl p-2 text-start">Ready to add a some money?
        ...
        <div className="addWalletSection p-2 h-[50vh] md:h-full md:w-1/3 lg:w-1/3 w-full justify-center lg:items-center md:items-center flex items-start">
            <form action="" className="flex flex-col w-full gap-2 p-2">
                ...
                <button className="bg-blue-500 p-2 text-white hover:bg-slate-50 hover:text-blue-500 delay hover:border">Add Income</button>
            </form>
        </div>
        </div>
    </div>  
